...
const Login = () => {
  ...
  const onSubmit = async () => {
    ...
    const result = await dispatch(
      getGuard({ email: email.toLowerCase(), password: password })
    );
    ...
    <>
      <View style={styles.container}>
        ...
        <View style={styles.viewInput}>
          ...
          />
          {error ? (
            <Text style={styles.error}>Email o contraseña inválidos. </Text>
          ) : null}

          <TouchableWithoutFeedback>
            <Text onPress={handleRecoverPassword} style={styles.text}>
