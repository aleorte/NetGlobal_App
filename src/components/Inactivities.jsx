...
import { Text, View, Button, ScrollView, StyleSheet, TouchableOpacity ,TouchableHighlight } from 'react-native'
...
const Inactivities = () => {
  ...
  return (
    <ScrollView style = {styles.containter}>
      ...
      <TouchableOpacity  onPress = {handleTask} style = {[styles.viewCardToday, visible ? styles.viewHeightBig : styles.viewHeightSmall]} >
